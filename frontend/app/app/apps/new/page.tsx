      ...
      <div className="w-full max-w-6xl mx-auto p-6">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h1 className="text-3xl font-bold text-slate-100">Add New App</h1>
                ...
                <div key={step.number} className="flex items-center">
                  <div className={`flex items-center gap-3 px-4 py-2 rounded-lg transition-colors ${
                    ...
                    <div className="text-sm">
                      <div className={`font-medium ${isActive ? "text-indigo-300" : isCompleted ? "text-emerald-300" : "text-slate-300"}`}>
                        {step.title}
                      </div>
                  ...
                  {index < steps.length - 1 && (
                    <div className={`w-8 h-0.5 mx-2 ${isCompleted ? "bg-emerald-400" : "bg-white/10"}`} />
                  )}
                </div>
              );
            })}
